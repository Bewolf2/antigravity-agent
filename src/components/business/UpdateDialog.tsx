...
const BusinessUpdateDialog: React.FC<BusinessUpdateDialogProps> = ({
  ...
  const renderContent = () => {
    ...
    if (presentation.kind === 'update-available' && updateInfo) {
      return (
        <div className="space-y-5">
    ...
    if (presentation.kind === 'downloading' && progress) {
      return (
        <div className="space-y-5">
          <div className="rounded-2xl border border-border/70 bg-muted/35 p-4">
    ...
    if (presentation.kind === 'ready-to-install') {
      return (
        <div className="space-y-5">

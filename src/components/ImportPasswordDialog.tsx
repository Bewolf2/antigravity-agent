    ...
    <BaseDialog
      ...
      title={
        <div className="flex items-center gap-2 text-foreground">
          ...
          <div>
            <div className="text-base font-semibold leading-none">{t('import.title')}</div>
            <div className="mt-1 text-xs font-normal text-muted-foreground">{t('import.password')}</div>
          </div>
        </div>
      }
    >
